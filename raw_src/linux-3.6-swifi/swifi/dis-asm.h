...
long do_disasm(unsigned long address, char * str);

unsigned char * get_opcode_addr(void);
unsigned char * get_modrm_addr(void);
unsigned char * get_sib_addr(void);
unsigned char * get_disp_addr(void);
unsigned char   get_disp_size(void);
unsigned char * get_rex_addr(void);
